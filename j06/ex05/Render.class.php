...
class Render
{
    ...
    public function __construct($width, $height, $filename)
    {
        ...
        if (Self::$verbose)
            printf("Render( width: %d, height: %d, filename: %s ) ) constructed\n", $_width, $_height, $_filename);
    }
    ...
    {
        if (Self::$verbose)
            printf("Render( width: %d, height: %d, filename: %s ) ) destructed\n", $_width, $_height, $_filename);
    }

    function __toString()
    {
        return (vsprintf("Render( width: %d, height: %d, filename: %s ) )", $_width, $_height, $_filename));
    }
